...
| [![C0MAN gameplay](docs/assets/examples/c0man-gameplay-thumb.png)](samples/c0man.rom)<br>[`c0man.rom`](samples/c0man.rom) | [C0MAN](https://www.file-hunter.com/Homebrew/?id=c0man) | *C0MAN* — a SCREEN 0 Pac-Man clone. This project is an experiment in human/AI collaboration between Arnaud de Klerk and Claude (Anthropic) — the whole game, from first line of code to the final build, was written in a few hours. See on [GitHub](https://github.com/TFHFony/c0man). | Human + Claude (Anthropic) → Z80 ASM + SjASMPlus → WebMSX (no MCP connector) |
